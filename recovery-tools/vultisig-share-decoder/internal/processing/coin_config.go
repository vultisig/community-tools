...
func GetSupportedCoins() []CoinConfig {
        return []CoinConfig{
                ...
                },
                {
                        ...
                        Action: func(key *hdkeychain.ExtendedKey, output *strings.Builder) error {
                                return CosmosLikeKeyHandler(key, "cosmos", "valoper", "valcons", output, "Atom")
                        },
                },
                {
                        Name:       "kujira",
                        DerivePath: "m/44'/118'/0'/0/0",
                        Action: func(key *hdkeychain.ExtendedKey, output *strings.Builder) error {
                                return CosmosLikeKeyHandler(key, "kujira", "valoper", "valcons", output, "Kujira")
                        },
                },
                {
                        Name:       "dydx",
                        DerivePath: "m/44'/118'/0'/0/0",
                        Action: func(key *hdkeychain.ExtendedKey, output *strings.Builder) error {
                                return CosmosLikeKeyHandler(key, "dydx", "valoper", "valcons", output, "dYdX")
                        },
                },
                {
                        Name:       "terra-classic",
                        DerivePath: "m/44'/118'/0'/0/0",
                        Action: func(key *hdkeychain.ExtendedKey, output *strings.Builder) error {
                                return CosmosLikeKeyHandler(key, "terra", "valoper", "valcons", output, "Terra Classic")
                        },
                },
                {
                        Name:       "terra",
                        DerivePath: "m/44'/118'/0'/0/0",
                        Action: func(key *hdkeychain.ExtendedKey, output *strings.Builder) error {
                                return CosmosLikeKeyHandler(key, "terra", "valoper", "valcons", output, "Terra")
                        },
                },
                {
                        Name:       "ethereum",
